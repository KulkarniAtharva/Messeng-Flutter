...
import 'package:Messenger/helpers/helper_functions.dart';
import 'package:Messenger/helpers/responsive_widget.dart';
import 'package:Messenger/helpers/theme.dart';
import 'package:Messenger/models/home_container_model.dart';
import 'package:Messenger/services/auth.dart';
import 'package:Messenger/services/database.dart';
import 'package:Messenger/services/search_service.dart';
import 'package:Messenger/views/chatinfo.dart';
...
class _WebHomeState extends State<WebHome>
{
  ...
  void initState()
  {
    ...
    databaseMethods.getChats(homeContainerModel.chatRoomIdGlobal).then((result)
    {
    ...
    return ResponsiveWidget(
      ...
      smallScreen: Scaffold(
        ...
        body: _myAvatar == null ? Container(
          ...
          children: <Widget>[
            homeContainerModel.isChatSelected ? Container() : Container(
            ...
            homeContainerModel.isChatSelected ? Container(
                width: MediaQuery.of(context).size.width,
                height: MediaQuery.of(context).size.height,
        ...
        children: <Widget>[
              ...
              child: Column(
                ...
                children: <Widget>[
                  Container(
                      ...
                      child: ClipRRect(
                          borderRadius: BorderRadius.circular(120),
                          child: kIsWeb ? Image.network(_myAvatar) : CachedNetworkImage(imageUrl: _myAvatar))),
                  SizedBox(
                    height: 16,
                  ),
                  Text(
          ...
          Opacity(
            ...
            child: Container(
              ...
              child: Container(
                padding: EdgeInsets.only(left: 16, right: 34, top: 10, bottom: 10),
                decoration: BoxDecoration(
  ...
  initiateSearch()
  {
    ...
    SearchService().searchByName(searchString).then((result)
    {
      setState(()
      {
        ...
        print(("this is ${querySnapshot.docs[0].toString()}"));
        setState(()
        {
          isLoading = false;
        });
  ...
  Widget recentUserList()
  {
    return Column(
      ...
      children: <Widget>[
        ...
        Container(
          child: usersSnapshot != null ? ListView.builder(
              itemCount: usersSnapshot.docs.length,
              shrinkWrap: true,
              itemBuilder: (context, index)
              {
                return userTile(
                  userEmail: usersSnapshot.docs[index].data()['email'],
                  userName: usersSnapshot.docs[index].data()['userName'],
                  userAvatarUrl: usersSnapshot.docs[index].data()['avatarUrl'],
                );
              })
              : Container(),
        ),
      ...
      child: querySnapshot != null ? ListView.builder(
          ...
          itemBuilder: (context, index)
          {
            return userTile(
              ...
              userAvatarUrl: querySnapshot.docs[index].data()['avatarUrl'],
            );
          })
          : Container(),
    );
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: ()
                      {
                        homeContainerModel.isSearching = !homeContainerModel.isSearching;
                      ...
                      child: Container(
                          padding: EdgeInsets.symmetric(horizontal: 16),
                          child: Text(
                            homeContainerModel.isSearching ? "Cancel" : "Find Dev",
                            style: TextStyle(
                                color: Colors.white,
                                fontFamily: "OverpassRegular",
                                fontSize: 15),
        ...
        GestureDetector(
          onTap: () async
          {
            if (userName != _myName)
            {
              ...
              String chatRoomid = getChatRoomId(userName, _myName); // "$userName\_${myName}";
              ...
              DatabaseMethods().addChatRoom(chatRoom, chatRoomid).then((val)
              {
                ...
                if (canMessage)
                {
                  ...
                  databaseMethods.getChats(chatRoomid).then((result)
                  {
                    ...
                    print("${homeContainerModel.messagesStream}   $messagesStreamHome");
...
void _moreOptionBottomSheet({@required BuildContext context, @required String chatRoomId})
{
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          fontSize: 14,
                          color: unreadMessages > 0 ? Colors.white : Colors.white,
                          fontFamily: 'OverpassRegular',
                        ),
                      ),
                    ),
