        ...
        : Scaffold(
            ...
            body: SingleChildScrollView(
              child: Container(
                ...
                padding: EdgeInsets.only(left: 24, right: 24, top: 30, bottom: 80),
                child: Form(
                  key: _formKey,
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          validator: (val) => val.length > 6 ? null : "Enter Password 6+ characters",
                          obscureText: true,
                        ),
                        SizedBox(
                          height: 16,
                        ...
                        GestureDetector(
                          onTap: () async
                          {
                            if (_formKey.currentState.validate())
                            {
                              ...
                              QuerySnapshot userInfoSnapshot = await _databaseMethods.getUserInfo(emailController.text);
                          ...
                          child: Container(
                            width: MediaQuery.of(context).size.width > 800 ? 400 : MediaQuery.of(context).size.width - 60,
                        ...
                        Container(
                          child: error.isEmpty ? Container() : Column(
                                  children: <Widget>[
                                    SizedBox(
                                      height: 8,
                                    ),
